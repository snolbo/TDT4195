...
def task2_grayscale_conversion(path):
    ...
    misc.imsave("task2_avgorig.tiff", img)
    misc.imsave("task2_avgflat.tiff", avg1)
    misc.imsave("task2_avglum.tiff", avg2)
    plotrgb(img)
    plot(avg1)
    plot(avg2)
...
def task3_inverse(path):
    ...
    inv = inverse(img, 8)
    misc.imsave("task3_inverseorig.tiff", img)
    misc.imsave("task3_inverse.tiff", inv)
    plot(img)
    plot(inv)
...
def task3_gamma(path):
    ...
    misc.imsave("task3_gammaorig.tiff", img)
    misc.imsave("task3_gamma1.tiff", gamma1)
    misc.imsave("task3_gamma2.tiff", gamma2)
    misc.imsave("task3_gamma3.tiff", gamma3)
    plot(img)
    plot(gamma1)
    plot(gamma2)
    plot(gamma3)
...
def task4_grayscale_convolution(path):
    ...
    misc.imsave("task4_convgrayorig.tiff", img)
    misc.imsave("task4_convgray3.tiff", conv3)
    misc.imsave("task4_convgray5.tiff", conv5)
    plot(img)
    plot(conv3)
    plot(conv5)
...
def task4_rgb_convolution(path):
    ...
    misc.imsave("task4_convrgborig.tiff", img)
    misc.imsave("task4_convrgb3.tiff", conv3)
    misc.imsave("task4_convrgb5.tiff", conv5)
    plotrgb(img)
    plotrgb(conv3)
    plotrgb(conv5)
...
def task4_gradients(path):
    ...
    misc.imsave("task4_Ix.tiff", img)
    misc.imsave("task4_Iy.tiff", Ix)
    misc.imsave("task4_magnitude.tiff", magnitude)
    plot(img)
    plot(Ix)
    plot(Iy)
    plot(magnitude)
